...
public class Controller implements Initializable {
    ...
    private class ConsoleOutput implements OutputHandler {
        ...
        public void connected(InetSocketAddress serverAddress){
            messageText.setText("Connected to " + serverAddress.getHostName() +":" + serverAddress.getPort());
        }

        @Override
        public void disconnected(){
            messageText.setText("Disconnected from server, please restart the client");
        }
